...
API_ID = int(environ.get('API_ID', '33267938'))  # Telegram API ID
API_HASH = environ.get('API_HASH', '13773055fa0dbc6198546acf6016187f')  # Telegram API Hash
BOT_TOKEN = environ.get('BOT_TOKEN', '8437887491:AAGbKWNskqtWR8-Wxwx_u4G--hEkbpYVzDg')  # Telegram Bot Token

# 👑, Channels & Logs
BIN_CHANNEL = int(environ.get("BIN_CHANNEL", '-1003322457825'))  # File storage channel
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", '-1003658472740'))  # General log channel
PREMIUM_LOGS = int(environ.get("PREMIUM_LOGS", '-1003580639842'))  # Premium user actions log
VERIFIED_LOG = int(environ.get('VERIFIED_LOG', '-1003688403318'))  # Verified user actions log
SUPPORT_GROUP = int(environ.get("SUPPORT_GROUP", "-1003629460390"))
...
BOT_USERNAME = environ.get("BOT_USERNAME", 'JaduFilebot')  # Bot's username

# 🔗 Channel & Support Links
CHANNEL = environ.get('CHANNEL', 'https://t.me/FileToLink_Update')  # Updates channel
SUPPORT = environ.get('SUPPORT', 'https://t.me/FileToLink_Update_Support')  # Support group
...
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'smallshorturl.mypivpanel.shop')  # Shortener site
SHORTLINK_API = environ.get('SHORTLINK_API', 'aa327faa1ccb980853b69b2ccf9b7ea0049bdc17')  # API key for shortlink

# 💾 MongoDB Connection Information
DB_URL = environ.get('DATABASE_URI', "mongodb+srv://kauaawhite:afiya1310@cluster0.okwjkmq.mongodb.net/?appName=Cluster0")  # MongoDB connection URI
